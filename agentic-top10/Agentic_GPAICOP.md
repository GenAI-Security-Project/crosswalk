...
## Why GPAI Code of Practice for Agentic Top 10 2026
...
| ASI04 | Agentic Supply Chain | High | 3 | DRAFT |
...
| Organizational risk culture | CoP-III-C8-M8.3 | Ch. III — Safety and Security | DRAFT — SME review required | DRAFT | DRAFT | DRAFT | GPAI CoP Final | (unreviewed) |
...
| Control | ID | Domain | How it applies | Relationship | Rationale type | Confidence | Framework ver. | Reviewed by |
|---|---|---|---|---|---|---|---|---|
| Market placement decisions | CoP-III-C4-M4.2 | Ch. III — Safety and Security | DRAFT — SME review required | DRAFT | DRAFT | DRAFT | GPAI CoP Final | (unreviewed) |
