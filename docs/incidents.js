...
window.CROSSWALK_INCIDENTS = [
  ...
  },
  {
    ...
    "mitigations": [
      ...
      "Red-team extended-conversation scenarios before deployment (LLM07 Misinformation, LLM03 Excessive Agency)"
    ],
    "references": [
      {
  ...
  },
  {
    ...
    "impact": "Model withdrawn within 72 hours of launch; scientific community backlash established reputational precedent for AI misinformation risk; demonstrates that domain-specialist training does not prevent hallucination and may amplify misinformation confidence; canonical case study for LLM07",
    "severity": "High",
    "mitigations": [
  ...
  {
    "id": "INC-115",
    "title": "ClawHavoc — 1,184 malicious skills flooded onto the ClawHub registry",
    "date": "2026-01",
    "year": 2026,
    "category": "real-world",
    "severity": "Critical",
    "description": "Between 27 and 29 January 2026 attackers registered as ClawHub developers and flooded the registry with 341 malicious skills in a three-day window; the final tally reported by Antiy CERT was 1,184 malicious skills across 12 publisher accounts, classified as Trojan/OpenClaw.PolySkill. All 335 AMOS-delivering skills shared a single C2 IP (91.92.242[.]30). Targeted data included exchange API keys, wallet private keys, SSH credentials, browser passwords and .env files. Skills also wrote malicious instructions directly into MEMORY.md and SOUL.md, backdooring the agent across later sessions. Koi Security named the campaign on 1 February and began coordinated removal; some packages persisted for weeks. This is the named campaign behind the \"341 malicious skills\" figure recorded in INC-102.",
    "owasp_entries": [
      "AST01",
      "AST02"
    ],
    ...
    "affected": "OpenClaw / ClawHub — 1,184 skills across 12 publisher accounts",
    "impact": "Credential and wallet theft at registry scale; session-persistent agent backdooring",
    "mitigations": [
      "Publisher identity verification on skill registries",
      "Signed skill manifests with content hashes",
      "Deny-write on agent identity files (MEMORY.md, SOUL.md)",
      "Egress allowlisting from skill execution contexts"
    ],
    "external_refs": [
      {
        "source": "research",
      ...
      {
        "source": "research",
        "id": "Koi Security — ClawHavoc analysis (2026-02-01)"
      },
      {
        "source": "research",
        "id": "Antiy CERT — ClawHavoc Campaign Analysis (Trojan/OpenClaw.PolySkill)"
      }
    ],
    "control_failures": [
      {
        ...
        "control_id": "L7",
        "outcome": "absent",
        "basis": "Instead, it exploited the absence of detection, analysis, and risk control capabilities and systems that should have been inherent in its open-source ecosystem.",
        "source_url": "https://www.antiy.net/p/clawhavoc-analysis-of-large-scale-poisoning-campaign-targeting-the-openclaw-skill-market-for-ai-agents/",
        "confirmed_by": []
      },
      {
        "framework": "MAESTRO",
        ...
        "basis": "It's to evade antivirus scanning - password-protected archives bypass automated analysis because the scanner can't see inside.",
        "source_url": "https://web.archive.org/web/20260811020443/https://www.koi.ai/blog/clawhavoc-341-malicious-clawedbot-skills-found-by-the-bot-they-were-targeting",
        "confirmed_by": []
      }
    ],
    "references": [
  ...
  {
    "id": "INC-116",
    "title": "SKILL.md to shell access in three lines of markdown (Snyk threat model)",
    "date": "2026-02",
    "year": 2026,
    "category": "research-demonstrated",
    "severity": "High",
    "description": "Snyk published a threat model on 3 February 2026 documenting how three lines of markdown in a SKILL.md file can instruct an agent to read SSH keys and exfiltrate them. The significance is that the payload is natural-language instruction, not code — nothing in the file is executable, so signature and pattern scanning has nothing to match on.",
    "owasp_entries": [
      "AST01",
      "AST04"
    ],
    ...
    "attack_vector": "Natural-language instructions in a skill manifest direct the agent to read and exfiltrate credentials",
    "affected": "Any agent runtime that executes third-party SKILL.md files",
    "impact": "Credential disclosure with no executable code for scanners to detect",
    "mitigations": [
      "Treat skill manifests as untrusted input, not documentation",
      "Explicit filesystem allow/deny lists per skill",
      "Semantic rather than signature-based review"
    ],
    "external_refs": [
      {
        "source": "research",
      ...
      {
        "source": "research",
        "id": "Snyk — From SKILL.md to Shell Access in Three Lines of Markdown (2026-02-03)"
      }
    ],
    "references": [
      {
    ...
    "control_failures": [
      {
        ...
        "control_id": "L7",
        "outcome": "absent",
        "basis": "No cryptographic signing or verification exists: the official guidance: \"treat third-party skills as trusted code. Read them before enabling.\"",
        "source_url": "https://snyk.io/articles/skill-md-shell-access/",
        "confirmed_by": []
      },
      {
        "framework": "MAESTRO",
        "control_id": "L4",
        "outcome": "absent",
        "basis": "Default execution runs without sandboxing: OpenClaw documentation explicitly states: \"tools run on the host for the main session, so the agent has full access when it's just you.\"",
        "source_url": "https://snyk.io/articles/skill-md-shell-access/",
        "confirmed_by": []
      }
    ]
  ...
  {
    "id": "INC-118",
    "title": "ToxicSkills — 36% of 3,984 audited skills contain security flaws",
    "date": "2026-02",
    "year": 2026,
    "category": "research-demonstrated",
    "severity": "High",
    "description": "Snyk published ToxicSkills on 5 February 2026, the first comprehensive security audit of the AI agent skill ecosystem. Across 3,984 skills scanned on ClawHub and skills.sh: 36% contained security flaws, 13.4% contained critical-level issues, 76 carried confirmed active malicious payloads, and 8 malicious skills were still live at the time of publication.",
    "owasp_entries": [
      "AST01",
      "AST03"
    ],
    ...
    "attack_vector": "Systemic insecurity of the published skill ecosystem — flawed and over-permissioned skills distributed at scale",
    "affected": "ClawHub and skills.sh — 3,984 skills audited",
    "impact": "13.4% of audited skills carried critical issues; 76 active malicious payloads",
    "mitigations": [
      "Registry-level security gating before publication",
      "Least-privilege permission declarations per skill"
    ],
    "external_refs": [
      {
        "source": "research",
      ...
      {
        "source": "research",
        "id": "Snyk — ToxicSkills (2026-02-05)"
      }
    ],
    "references": [
      {
    ...
    "control_failures": [
      {
        ...
        "control_id": "L7",
        "outcome": "absent",
        "basis": "No code signing. No security review. No sandbox by default.",
  ...
  },
  {
    ...
    "mitigations": [
      "Explicit path and network allowlists instead of wildcards",
      "Permission review at publication"
    ],
    "external_refs": [
      {
        "source": "research",
    ...
    "control_failures": [
      {
        ...
        "control_id": "L6",
        "outcome": "absent",
        "basis": "The flaw: It blindly extracts and outputs .jsonl session files without redaction.",
        "source_url": "https://snyk.io/blog/openclaw-skills-credential-leaks-research/",
        "confirmed_by": []
      }
    ]
  },
  {
    "id": "INC-120",
    "title": "Brand-impersonating skill on ClawHub tricks users into installing malware",
    "date": "2026-02",
    "year": 2026,
    "category": "real-world",
    "severity": "High",
    "description": "On 10 February 2026 Snyk documented a malicious skill on ClawHub impersonating a Google product, confirming typosquatting and fake brand impersonation as active tactics in the skill ecosystem rather than theoretical ones.",
    "owasp_entries": [
      "AST01",
      "AST04"
    ],
    ...
    "attack_vector": "Typosquatting and brand impersonation in skill metadata to obtain installation",
    "affected": "ClawHub users",
    "impact": "Malware installation obtained through a false trust signal",
    "mitigations": [
      "Verified publisher badges tied to identity",
      "Namespace protection for known brands",
      "Metadata integrity checks at publication"
    ],
    "external_refs": [
      {
        "source": "research",
      ...
      {
        "source": "research",
        "id": "Snyk — How a Malicious Google Skill on ClawHub Tricks Users Into Installing Malware (2026-02-10)"
      }
    ],
    "references": [
      {
    ...
    "control_failures": [
      {
        ...
        "control_id": "L7",
        "outcome": "present-but-bypassed",
        "basis": "While ClawHub has recently introduced stronger controls, such as requiring accounts to be one week old and hiding skills with more than three reports, attackers are adapting faster than the platform can police itself.",
        "source_url": "https://snyk.io/blog/clawhub-malicious-google-skill-openclaw-malware/",
        "confirmed_by": []
      }
    ]
  },
  {
    "id": "INC-121",
    "title": "Pattern-matching skill scanners miss the majority of critical threats",
    "date": "2026-02",
    "year": 2026,
    "category": "research-demonstrated",
    "severity": "Medium",
    "description": "Snyk's \"Why Your Skill Scanner Is Just False Security (and Maybe Malware)\", published 11 February 2026, demonstrated that pattern-matching scanners miss the majority of critical threats, because those threats rely on natural-language instruction manipulation rather than code signatures.",
    "owasp_entries": [
      "AST08"
    ],
    "maestro_layers": [
    ...
    "attack_vector": "Instruction-level payloads that carry no code signature for a pattern scanner to detect",
    "affected": "Skill scanners across the ecosystem",
    "impact": "A clean scan result that carries no assurance — false security",
    "mitigations": [
      "Semantic and behavioural analysis alongside signature scanning",
      "Publish scanner identity, date and result with each skill (scan_status)"
    ],
    "external_refs": [
      {
        "source": "research",
      ...
      {
        "source": "research",
        "id": "Snyk — Why Your Skill Scanner Is Just False Security (and Maybe Malware) (2026-02-11)"
      }
    ],
    "references": [
      {
    ...
    "control_failures": [
      {
        ...
        "control_id": "L5",
        "outcome": "failed",
        "basis": "The scanner failed to catch the actual threat because our exfiltration code in the fake Vercel skill didn't match its hardcoded list of \"bad\" strings.",
        "source_url": "https://snyk.io/blog/skill-scanner-false-security/",
        "confirmed_by": []
      }
    ]
  },
  {
    "id": "INC-122",
    "title": "OpenClaw log poisoning — agent logs as an indirect prompt injection channel",
    "date": "2026-02",
    "year": 2026,
    "category": "real-world",
    "severity": "High",
    "description": "Patched in OpenClaw 2026.2.13 on 14 February 2026. Attackers could write malicious content to agent log files via WebSocket requests. Because the agent reads its own logs for troubleshooting, injected text could influence its decisions and trigger indirect prompt injection — the agent's own diagnostic record used as an untrusted input channel.",
    "owasp_entries": [
      "AST04",
      "AST05"
    ],
    ...
    "attack_vector": "WebSocket-written log content read back by the agent as trusted context",
    "affected": "OpenClaw before 2026.2.13",
    "impact": "Indirect prompt injection through the agent's own logs",
    "mitigations": [
      "Treat agent-readable logs as untrusted input",
      "Authenticate and validate log-write paths",
      "Separate diagnostic logs from context the agent consumes"
    ],
    "external_refs": [
      {
        "source": "research",
      ...
      },
      {
        ...
        "id": "OpenClaw 2026.2.13 — log poisoning patch (2026-02-14)"
      }
    ],
    "references": [
      {
  ...
  {
    "id": "INC-123",
    "title": "Claude Code repository config execution before trust dialog (CVE-2025-59536, CVE-2026-21852)",
    "date": "2026-02",
    "year": 2026,
    "category": "real-world",
    "severity": "High",
    "description": "Check Point Research publicly disclosed CVE-2025-59536 (CVSS 8.7) and CVE-2026-21852 (CVSS 5.3) in Claude Code on 25 February 2026. Both had been patched months earlier. The disclosure confirmed that repository-controlled configuration files could silently execute arbitrary shell commands and exfiltrate API keys at project open time, before any trust dialog was shown — the consent step existed but ran after the code it was meant to gate.",
    "owasp_entries": [
      "AST02",
      "AST04"
    ],
    ...
    "affected": "Claude Code, prior to patch",
    "impact": "Arbitrary command execution and API key exfiltration on opening an untrusted repository",
    "mitigations": [
      "Run consent gates before any repository-supplied configuration is evaluated",
      "Treat repository config as untrusted data until explicitly trusted"
    ],
    "external_refs": [
      {
        "source": "research",
      ...
      {
        "source": "research",
        "id": "Check Point Research — Claude Code configuration execution (2026-02-25)"
      }
    ],
    "control_failures": [
      {
        ...
        "control_id": "L6",
        "outcome": "present-but-bypassed",
        "basis": "Due to a bug in the startup trust dialog implementation, Claude Code could be tricked to execute code contained in a project before the user accepted the startup trust dialog.",
        "source_url": "https://github.com/anthropics/claude-code/security/advisories/GHSA-4fgq-fpq9-mr3g",
        "confirmed_by": []
      },
      {
        "framework": "MAESTRO",
        "control_id": "L6",
        "outcome": "present-but-bypassed",
        "basis": "Claude Code would issue API requests before showing the trust prompt, including potentially leaking the user's API keys.",
        "source_url": "https://github.com/anthropics/claude-code/security/advisories/GHSA-jh7p-qr78-84p7",
        "confirmed_by": []
      }
    ],
    "references": [
  ...
  },
  {
    ...
    "mitigations": [
      "Rate-limit and authenticate localhost control channels",
      "Require an explicit user prompt for device registration",
    ...
    "control_failures": [
      {
        ...
        "basis": "The gateway's rate limiter completely exempts loopback connections—failed attempts are not counted, not throttled, and not logged.",
      ...
      },
      {
        ...
        "control_id": "L6",
        "outcome": "present-but-misconfigured",
        "basis": "The gateway auto-approves device pairings from localhost with no user prompt.",
        "source_url": "https://www.oasis.security/blog/openclaw-vulnerability",
        "confirmed_by": []
      }
    ],
  ...
  },
  {
    ...
    "mitigations": [
      ...
      "Deny-write and deny-read scoping on identity files"
    ],
    "external_refs": [
      {
        "source": "research",
  ...
  {
    "id": "INC-126",
    "title": "36.7% of 7,000+ MCP servers potentially vulnerable to SSRF",
    "date": "2026-02",
    "year": 2026,
    "category": "research-demonstrated",
    "severity": "High",
    "description": "BlueRock Security analysed more than 7,000 MCP servers in February 2026 and found 36.7% potentially vulnerable to server-side request forgery. A proof of concept against Microsoft's MarkItDown MCP server retrieved AWS IAM keys from the EC2 metadata endpoint.",
    "owasp_entries": [
      "AST03",
      "AST06"
    ],
    ...
    "attack_vector": "SSRF through an MCP server reaching the cloud instance metadata endpoint",
    "affected": "MCP server ecosystem — 7,000+ servers analysed",
    "impact": "Cloud credential theft from the agent's own tool layer",
    "mitigations": [
      "Egress allowlisting from tool servers",
    ...
    "external_refs": [
      ...
      {
        "source": "research",
        "id": "BlueRock Security — MCP server SSRF analysis (2026-02)"
      }
    ],
    "references": [
      {
    ...
    "control_failures": [
      {
        ...
        "control_id": "L4",
        "outcome": "absent",
        "basis": "MarkItDownMCP does not validate the urls provided to it.",
        "source_url": "https://www.bluerock.io/post/mcp-furi-microsoft-markitdown-vulnerabilities",
        "confirmed_by": []
      }
    ]
  },
  {
    "id": "INC-127",
    "title": "135,000+ OpenClaw instances internet-exposed with insecure defaults",
    "date": "2026-03",
    "year": 2026,
    "category": "real-world",
    "severity": "Critical",
    "description": "SecurityScorecard confirmed in March 2026 that more than 135,000 OpenClaw instances were publicly exposed on the internet with insecure defaults, and that over 53,000 correlated with prior breach activity. Bitdefender telemetry separately confirmed employees deploying OpenClaw on corporate devices with no SOC visibility.",
    "owasp_entries": [
      "AST06",
      "AST09"
    ],
    ...
    "attack_vector": "Direct exposure of agent runtimes with default configuration, deployed outside any governance boundary",
    "affected": "OpenClaw — 135,000+ exposed instances; 53,000+ correlated with prior breach activity",
    "impact": "Large-scale unmanaged agent exposure with no organisational visibility",
    "mitigations": [
      "Secure defaults with no internet-facing control plane",
      "Inventory and discovery for agent runtimes on managed devices",
      "Governance policy covering agent deployment"
    ],
    "external_refs": [
      {
        "source": "research",
      ...
      {
        "source": "research",
        "id": "SecurityScorecard — exposed OpenClaw instances (2026-03)"
      },
      {
        "source": "research",
        "id": "Bitdefender telemetry — unmanaged OpenClaw on corporate devices (2026-03)"
      }
    ],
    "references": [
      {
    ...
    "control_failures": [
      {
        ...
        "control_id": "L4",
        "outcome": "present-but-misconfigured",
        "basis": "Out of the box, OpenClaw binds by default to 0.0.0.0:18789, meaning it listens on all interfaces unless an operator explicitly restricts it.",
        "source_url": "https://www.bitdefender.com/en-us/blog/hotforsecurity/135k-openclaw-ai-agents-exposed-online",
        "confirmed_by": []
      }
    ]
  },
  {
    "id": "INC-128",
    "title": "Every public skill scanner bypassed in under an hour (Trail of Bits)",
    "date": "2026-06",
    "year": 2026,
    "category": "research-demonstrated",
    "severity": "High",
    "description": "Trail of Bits published \"The Sorry State of Skill Distribution\" on 3 June 2026. Every public skill scanner tested — ClawHub's VirusTotal plus LLM guard model, Cisco's skill-scanner, and the skills.sh scanners — was bypassed in under an hour, using payload padding that forces truncation, logic hidden in binary and archive formats, and prompt injection against the scanner's own LLM judge.",
    "owasp_entries": [
      "AST08"
    ],
    "maestro_layers": [
    ...
    "attack_vector": "Truncation-forcing payload padding, logic hidden in binary/archive formats, and prompt injection against the scanning model",
    "affected": "ClawHub, Cisco skill-scanner, skills.sh scanners",
    "impact": "A passing scan result carries no assurance across the entire public skill ecosystem",
    "mitigations": [
      "Scan the full artifact without truncation",
      "Unpack archives and binaries before analysis",
      "Isolate the scanning model from the content it judges"
    ],
    "external_refs": [
      {
        "source": "research",
      ...
      {
        "source": "research",
        "id": "Trail of Bits — The Sorry State of Skill Distribution (2026-06-03)"
      }
    ],
    "references": [
      {
    ...
    "control_failures": [
      {
        ...
        "control_id": "L5",
        "outcome": "present-but-bypassed",
        "basis": "We recently bypassed ClawHub’s malicious skill detector, Cisco’s agent skill scanner, and all three of the scanners integrated into skills.sh.",
  ...
  {
    "id": "INC-129",
    "title": "The Story of Skills — a malicious skill reaches 26,000 agents past every scanner",
    "date": "2026-06",
    "year": 2026,
    "category": "research-demonstrated",
    "severity": "High",
    "description": "Air Security published \"The Story of Skills\" on 22 June 2026: a researcher-built malicious skill reached more than 26,000 agents while every scanner cleared it. The payload was not in the skill at all — it was served from an attacker-controlled external documentation URL that the skill instructed the agent to fetch, so there was nothing in the published artifact to scan.",
    "owasp_entries": [
      "AST05",
      "AST08"
    ],
    ...
    "affected": "26,000+ agents",
    "impact": "Arbitrary attacker-controlled instructions delivered to agents that passed every available scan",
    "mitigations": [
      "Treat externally fetched documentation as untrusted input",
      "Domain allowlisting for skill-initiated fetches",
      "Pin and hash external content a skill depends on"
    ],
    "external_refs": [
      {
        "source": "research",
      ...
      {
        "source": "research",
        "id": "Air Security — The Story of Skills (2026-06-22)"
      }
    ],
    "references": [
      {
    ...
    "control_failures": [
      {
        ...
        "control_id": "L5",
        "outcome": "failed",
        "basis": "We started by running our skill locally against Cisco's and Nvidia's scanners, and all of skills.sh's scanners: All vetted brand-landingpage as safe.",
        "source_url": "https://www.air.security/blog-posts/the-story-of-skills",
        "confirmed_by": []
      },
      {
        "framework": "MAESTRO",
        "control_id": "L7",
        "outcome": "failed",
        "basis": "The bottom line: every signal people use to judge a skill cleared it - scanners, stars, reputation. Every one of them failed, and 26,000 agents were compromised.",
        "source_url": "https://www.air.security/blog-posts/the-story-of-skills",
        "confirmed_by": []
      }
    ]
  ...
  {
    "id": "INC-130",
    "title": "The Circus of Skills — 17,822 live skills rest on untrusted external instruction sources",
    "date": "2026-06",
    "year": 2026,
    "category": "research-demonstrated",
    "severity": "High",
    "description": "Air Security scanned 142,836 live skills and published the results on 24 June 2026: 17,822 of them — 12.4%, accounting for 6.7 million installs — rest on at least one untrusted external instruction source. The pattern demonstrated in \"The Story of Skills\" is not an outlier but an ecosystem default.",
    "owasp_entries": [
      "AST05"
    ],
    "maestro_layers": [
    ...
    "affected": "17,822 skills of 142,836 scanned; 6.7M installs",
    "impact": "Ecosystem-wide exposure to post-publication instruction changes by uncontrolled parties",
    "mitigations": [
      "Declare and pin external instruction sources in the manifest",
      "Content hashing for fetched instructions",
      "Domain allowlisting"
    ],
    "external_refs": [
      {
      ...
      {
        "source": "research",
        "id": "Air Security — The Circus of Skills (2026-06-24)"
      }
    ],
    "references": [
      {
  ...
  {
    "id": "INC-131",
    "title": "SkillJacking — 925 skills sit on instantly hijackable dependencies",
    "date": "2026-07",
    "year": 2026,
    "category": "research-demonstrated",
    "severity": "High",
    "description": "Air Security published \"SkillJacking\" on 2 July 2026: 925 skills serving roughly 134,000 agents sit on instantly hijackable dependencies — deleted GitHub accounts, unregistered packages, expired domains and freed cloud-app slots. The researchers took over the most popular video-generation skill on skills.sh, with 11,483 installs, simply by re-registering its deleted owner account.",
    "owasp_entries": [
      "AST07",
      "AST10"
    ],
    ...
    "attack_vector": "Re-registration of abandoned dependency identifiers — deleted accounts, unregistered packages, expired domains, freed cloud-app slots",
    "affected": "925 skills, ~134,000 agents; demonstrated takeover of a skill with 11,483 installs",
    "impact": "Silent ownership transfer of installed skills to an arbitrary third party",
    "mitigations": [
      "Pin dependencies by content hash, not by name",
      "Registry checks for dangling identifiers",
      "Alert on publisher-account change for installed skills"
    ],
    "external_refs": [
      {
        "source": "research",
      ...
      {
        "source": "research",
        "id": "Air Security — SkillJacking (2026-07-02)"
      }
    ],
    "references": [
      {
    ...
    "control_failures": [
      {
        ...
        "control_id": "L7",
        "outcome": "present-but-misconfigured",
        "basis": "GitHub does block re-creating previously very popular repositories, but the bar to qualify is high enough that most of the dangling repos we found weren't covered by it.",
        "source_url": "https://www.air.security/blog-posts/skilljacking",
        "confirmed_by": []
      }
    ]
  }
