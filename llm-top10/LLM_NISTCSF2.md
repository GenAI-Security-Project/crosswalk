...
| LLM03 | Excessive Agency | Critical | PR.AA-05, PR.AA-01, DE.CM-01, GV.OC-01 | Foundational–Hardening |
| LLM04 | Supply Chain | High | GV.SC-01, GV.SC-06, ID.AM-08, PR.PS-02 | Foundational–Hardening |
| LLM05 | Data and Model Poisoning | Critical | PR.DS-01, DE.CM-09, ID.RA-01, RS.AN-03 | Hardening–Advanced |
| LLM06 | Unbounded Consumption | High | PR.IR-01, DE.CM-01, RS.MI-01, GV.RM-01 | Foundational–Hardening |
| LLM07 | Misinformation | High | GV.OC-01, DE.CM-09, ID.RA-01, PR.AT-01 | Foundational–Hardening |
| LLM08 | Hidden Context Exposure | High | PR.DS-01, PR.AA-05, DE.CM-01, GV.RM-06 | Foundational–Hardening |
| LLM09 | Vector and Embedding Weaknesses | Medium | PR.DS-01, PR.DS-02, DE.CM-09, ID.AM-08 | Hardening–Advanced |
| LLM10 | Improper Output Handling | High | PR.PS-04, PR.DS-02, DE.CM-01, ID.RA-01 | Foundational–Hardening |
...
CSF 2.0 data security (PR.DS) and access control
...
|---|---|---|---|
| GOVERN | LLM04, LLM03, LLM07 | GV.SC-01, GV.OC-01, GV.RM-01/06 | Supply chain programme live, acceptable use policy published, risk register complete |
| IDENTIFY | LLM01, LLM02, LLM05 | ID.AM-08, ID.RA-01, ID.RA-08 | All LLM assets inventoried, risk assessments complete, threat intel subscriptions active |
| PROTECT | LLM01, LLM02, LLM03 | PR.DS-01/02, PR.AA-01/05, PR.PS-04 | Encryption, access controls, and secure development requirements implemented |
| DETECT | LLM05, LLM09, LLM06 | DE.CM-01/09, DE.AE-02 | Production monitoring live for all LLM systems, anomaly alerts operational |
| RESPOND | LLM01, LLM05, LLM06 | RS.AN-03, RS.MI-01/02 | Incident response procedures tested for all LLM-specific scenarios |
| RECOVER | LLM06 | RC.RP-01 | BCP covers LLM availability, RTO/RPO defined and tested |
...
|---|---|---|---|
| 1 — GOVERN + IDENTIFY | LLM04, LLM03 | GV.SC-01, ID.AM-08 | Asset inventory and supply chain governance before technical controls |
| 2 — PROTECT | LLM01, LLM02, LLM10 | PR.DS, PR.AA, PR.PS-04 | Data protection and access control close the most common breach paths |
| 3 — DETECT | LLM05, LLM09, LLM06 | DE.CM-01/09 | Monitoring programme covers poisoning, vector store, and consumption risks |
