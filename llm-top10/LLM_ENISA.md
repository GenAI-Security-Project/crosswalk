...
| LLM03 | Excessive Agency | Critical | GOV, ASI, MON | L2–L3 | Foundational–Hardening |
| LLM04 | Supply Chain | High | SCS, DMS, GOV | L1–L2 | Foundational–Hardening |
| LLM05 | Data and Model Poisoning | Critical | DMS, ASI, MON | L2 | Hardening–Advanced |
| LLM06 | Unbounded Consumption | High | L1, MON, IRS | L1 | Foundational–Hardening |
| LLM07 | Misinformation | High | ASI, GOV, MON | L2 | Foundational–Hardening |
| LLM08 | Hidden Context Exposure | High | DMS, GOV, MON | L1–L2 | Foundational–Hardening |
| LLM09 | Vector and Embedding Weaknesses | Medium | DMS, ASI, MON | L2 | Hardening–Advanced |
| LLM10 | Improper Output Handling | High | ASI, MON, L1 | L1–L2 | Foundational–Hardening |
...
- **OT engineer (NIS2 essential entity)** — L3 sector-specific entries, LLM01/LLM05/LLM06
...
ENISA DMS (Data and Model Security) governs system
...
|---|---|---|---|
| L1 — General ICT | LLM04, LLM10, LLM06 | Secure Development, Supply Chain, Availability | Baseline ICT security for all LLM infrastructure |
| L2 — AI-specific | LLM01, LLM02, LLM05 | ASI, DMS, MON | AI-specific controls verified — adversarial testing, data governance, AI monitoring live |
| L3 — Sector-specific | LLM01, LLM03, LLM06 | GOV, IRS | NIS2 essential entity obligations met — incident assessment, reporting procedures tested |
...
| EU AI Act | Art. 10 — Data governance | DMS | LLM02, LLM05, LLM09 |
| EU AI Act | Art. 13 — Transparency | GOV | LLM07 |
| EU AI Act | Art. 14 — Human oversight | GOV | LLM03 |
| EU AI Act | Art. 15 — Robustness and cybersecurity | ASI | LLM01, LLM05, LLM10 |
| NIS2 | Art. 21 — Security measures | L1/L2 | All entries |
| NIS2 | Art. 23 — Incident reporting | IRS | LLM01, LLM03, LLM06 |
...
|---|---|---|---|
| 1 — L1 baseline | LLM04, LLM10, LLM06 | L1 Supply Chain, Secure Dev, Availability | ICT security foundation before AI-specific controls |
| 2 — L2 AI-specific | LLM01, LLM02, LLM05 | ASI, DMS, MON | AI-specific controls address highest-severity risks |
| 3 — Governance | LLM03, LLM07 | GOV | Policy and risk management covering autonomy and accuracy |
| 4 — Advanced testing | LLM08, LLM09 | ASI adversarial testing | Configuration and embedding security hardening |
