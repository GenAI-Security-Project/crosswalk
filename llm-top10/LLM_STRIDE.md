...
# LLM Top 10 2026 × STRIDE

Mapping the [OWASP Top 10 for LLM Applications 2026](https://genai.owasp.org/llm-top-10/)
to the
[STRIDE threat modelling taxonomy](https://learn.microsoft.com/en-us/azure/security/develop/threat-modeling-tool-threats)
...
| LLM03 | Excessive Agency | Critical | E, T, D | Foundational–Hardening | Build |
| LLM04 | Supply Chain | High | T, S, E | Foundational–Hardening | Both |
| LLM05 | Data and Model Poisoning | Critical | T, R | Hardening–Advanced | Both |
| LLM06 | Unbounded Consumption | High | D | Foundational–Hardening | Both |
| LLM07 | Misinformation | High | T, R | Foundational–Hardening | Both |
| LLM08 | Hidden Context Exposure | High | I, R | Foundational–Hardening | Build |
| LLM09 | Vector and Embedding Weaknesses | Medium | T, I | Hardening–Advanced | Build |
| LLM10 | Improper Output Handling | High | T, E | Foundational–Hardening | Build |
...
- **AppSec reviewer** — LLM08, LLM09, LLM10
- **SOC analyst** — LLM01, LLM02, LLM03, LLM06
- **OT engineer** — LLM01, LLM03, LLM05 (see ISA 62443 crosswalk for OT-specific controls)
...
- Implement prompt confidentiality monitoring — detect response patterns that
  indicate hidden context exposure
...
|---|---|---|---|
| 1 — Do now | LLM01, LLM10, LLM03 | T, S, E | Tampering and privilege escalation with active exploitation paths |
| 2 — This sprint | LLM02, LLM08 | I, R | Information disclosure closes the most common data exposure paths |
| 3 — This quarter | LLM04, LLM05 | T, S | Supply chain and poisoning require pipeline-level architectural changes |
| 4 — Ongoing | LLM09, LLM07, LLM06 | T, I, D | Defence-in-depth, monitoring, and resilience hardening |
