...
| LLM03 | Excessive Agency | Critical | V4.1, V11.1, V7.2 | L1–L3 | Foundational–Hardening |
| LLM04 | Supply Chain | High | V10.2, V14.2, V1.1 | L2–L3 | Foundational–Hardening |
| LLM05 | Data and Model Poisoning | Critical | V5.1, V10.2, V12.1 | L2–L3 | Hardening–Advanced |
| LLM06 | Unbounded Consumption | High | V13.1, V11.1, V7.4 | L1–L3 | Foundational–Hardening |
| LLM07 | Misinformation | High | V11.1, V7.4, V5.2 | L1–L2 | Foundational–Hardening |
| LLM08 | Hidden Context Exposure | High | V8.1, V4.1, V7.2 | L1–L2 | Foundational–Hardening |
| LLM09 | Vector and Embedding Weaknesses | Medium | V4.1, V6.1, V12.1 | L2–L3 | Hardening–Advanced |
| LLM10 | Improper Output Handling | High | V5.2, V5.3, V13.1 | L1–L3 | Foundational–Hardening |
...
- **OT engineer** — LLM01, LLM03, LLM06 with ISA 62443 crosswalk for OT context
