...
# LLM Top 10 2026 — OWASP AI Testing Guide
...
| LLM03 | Excessive Agency | Critical | ACT, AST, LMT | Foundational–Advanced |
| LLM04 | Supply Chain | High | SCT, MBT, AST | Foundational–Hardening |
| LLM05 | Data and Model Poisoning | Critical | DPT, MBT, SCT | Hardening–Advanced |
| LLM06 | Unbounded Consumption | High | AVT, LMT, ACT | Foundational–Hardening |
| LLM07 | Misinformation | High | MBT, OHT, LMT | Foundational–Hardening |
| LLM08 | Hidden Context Exposure | High | IHT, DPT, MBT | Foundational–Hardening |
| LLM09 | Vector and Embedding Weaknesses | Medium | DPT, SCT, ACT | Hardening–Advanced |
| LLM10 | Improper Output Handling | High | OHT, IHT, ACT | Foundational–Hardening |
...
- **Red team** — LLM01, LLM05, LLM08 entries, adversarial test design
...
Testing must cover both direct extraction
...
1. **Select scope** — identify which LLM Top 10 entries are in scope
   for your deployment based on features (RAG = LLM09, tool use = LLM03,
...
|---|---|---|---|
| P1 — Critical, test before any deployment | LLM01, LLM05 | Prompt injection and poisoning — fundamental to all LLM security | IHT, DPT |
| P2 — High, include in first test cycle | LLM02, LLM10, LLM03 | Data disclosure, output injection, excessive agency | DPT, OHT, ACT |
| P3 — High, include in first test cycle | LLM04, LLM08 | Supply chain and prompt leakage | SCT, IHT |
| P4 — Medium, include in quarterly review | LLM09, LLM07, LLM06 | Embedding attacks, misinformation, consumption | DPT, MBT, AVT |
