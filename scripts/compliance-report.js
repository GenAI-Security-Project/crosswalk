...
function renderMarkdown(fw, allEntries, opts) {
  ...
  lines.push(`> Source: https://github.com/GenAI-Security-Project/crosswalk`);
  ...
  lines.push('---');
  lines.push('');
  lines.push('_Generated by [OWASP GenAI Crosswalk](https://github.com/GenAI-Security-Project/crosswalk) · '
    + `CC BY-SA 4.0 · ${date}_`);
...
function renderSummaryMarkdown(frameworks, allEntries, opts) {
  ...
  lines.push('---');
  lines.push('');
  lines.push(`_Generated by [OWASP GenAI Crosswalk](https://github.com/GenAI-Security-Project/crosswalk) · CC BY-SA 4.0 · ${date}_`);
    ...
    'component-definition': {
      ...
      metadata: {
        ...
        parties: [{
          ...
          links: [{ href: 'https://github.com/GenAI-Security-Project/crosswalk', rel: 'homepage' }],
        }],
      ...
      components: [{
        ...
        'control-implementations': [{
          uuid: crypto.randomUUID(),
          source: 'https://github.com/GenAI-Security-Project/crosswalk',
          ...
          'implemented-requirements': [...r.controls.values()].flatMap(ctrl =>
            ctrl.entries.map(entry => ({
              ...
              props: [
                ...
                { name: 'implementation-status', value: 'planned', ns: 'https://github.com/GenAI-Security-Project/crosswalk' },
                { name: 'owasp-entry', value: entry.id, ns: 'https://github.com/GenAI-Security-Project/crosswalk' },
                { name: 'severity', value: entry.severity, ns: 'https://github.com/GenAI-Security-Project/crosswalk' },
                { name: 'source-list', value: entry.source_list, ns: 'https://github.com/GenAI-Security-Project/crosswalk' },
              ],
              links: [
                { href: `https://github.com/GenAI-Security-Project/crosswalk/blob/main/data/entries/${entry.id}.json`, rel: 'reference' },
              ],
            }))
          ),
        }],
      ...
      'back-matter': {
        resources: r.uncovered.map(entry => ({
          ...
          props: [
            { name: 'gap-severity', value: entry.severity, ns: 'https://github.com/GenAI-Security-Project/crosswalk' },
          ],
        })),
      },
    },
    ...
    catalog: {
        ...
        controls: ctrls.map(ctrl => {
          ...
          return {
            ...
            props: [
              ...
              ...(mappedData ? [
                { name: 'owasp-coverage', value: mappedData.entries.map(e => e.id).join(','), ns: 'https://github.com/GenAI-Security-Project/crosswalk' },
                { name: 'coverage-count', value: String(mappedData.entries.length), ns: 'https://github.com/GenAI-Security-Project/crosswalk' },
              ] : [
                { name: 'owasp-coverage', value: 'none', ns: 'https://github.com/GenAI-Security-Project/crosswalk' },
              ]),
            ],
            links: mappedData ? mappedData.entries.map(e => ({
              href: `https://github.com/GenAI-Security-Project/crosswalk/blob/main/data/entries/${e.id}.json`,
              rel: 'related',
              text: `${e.id}: ${e.name}`,
            })) : [],
          };
      ...
      'back-matter': {
        resources: [{
          ...
          rlinks: [{ href: 'https://github.com/GenAI-Security-Project/crosswalk' }],
        }],
      },
    },
  };
